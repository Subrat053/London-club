...
const betK3 = async (req, res) => {
    ...
    try {
        ...
        if (check >= 0) {
            ...
            await connection1.execute(sql, [id_product, userInfo.phone, userInfo.code, userInfo.invite, period.period, userInfo.level, total, price, xvalue, fee, game, gameJoin, typeGame, listJoin, 0, timeNow]);
            ...
            today = ?,
            time = ?`;
            await connection1.execute(sqlInsert, [id_product, userInfo.phone, userInfo.code, userInfo.invite, period.period, userInfo.level, price, xvalue, fee, typeGame,listJoin, 0, checkTime, timeNow]);
            ...
            await updateVipLevel(userInfo.phone,userInfo.vip_level);
