...
const initWebRouter = (app) => {
    // Register modular auth routes first so legacy login URL can stay intact with Google-only sign-in.
    registerAuthRoutes(router);

    // page account
    router.get('/keFuMenu', accountController.keFuMenu);
    router.get('/login', accountController.loginPage);
    router.get('/admin/login', accountController.loginPage);
    router.get('/register', accountController.registerPage);
    router.get('/forgot', accountController.forgotPage);
    router.post('/api/webapi/send-otp', accountController.verifyCode);
    ...
    router.get('/rebateHistory', middlewareController, homeController.rebateHistory);
    router.get('/expHistory', middlewareController, homeController.expHistory);
    router.get('/safe', middlewareController, homeController.safe);
    router.get('/safe-history', middlewareController, homeController.safeHistory);
    ...
    router.get('/admin/manager/content', adminController.middlewareAdminController, adminController.contentManagerPage); // get info account
    ...
    router.get('/api/admin/content/home', adminController.middlewareAdminController, adminController.getHomeContentSettings);
    router.post('/api/admin/content/home', adminController.middlewareAdminController, adminController.saveHomeContentSettings);
    ...
    //Activity
    router.post('/api/webapi/activity/bats',middlewareController,activityController.getTodayBat);
    router.post('/api/webapi/activity/rewards',middlewareController,activityController.getActivityReward);
    
    //Inviattaion
    router.post('/api/webapi/invitationList',middlewareController,userController.getInvitationData);

    //Rebets
    router.post('/api/webapi/rebats',middlewareController,userController.getRebate);
    router.post('/api/webapi/transfer-rebate',middlewareController,userController.transferRebate);
    router.post('/api/webapi/rebats-history',middlewareController,userController.getRebateHistory);
    
    //vip
    router.post('/api/webapi/vip',middlewareController,vipController.getVip);
    router.post('/api/webapi/exp-history',middlewareController,vipController.getExpHistory);

    //safe
    router.post('/api/webapi/safe',middlewareController,vipController.getSafe);
    router.post('/api/webapi/transferToSafe',middlewareController,vipController.transferToSafe);
    router.post('/api/webapi/transferOut',middlewareController,vipController.transferOut);
    router.post('/api/webapi/safeHistory',middlewareController,vipController.SafeHistory);
